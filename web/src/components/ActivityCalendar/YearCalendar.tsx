...
const MonthCard = memo(({ month, data, maxCount, onDateClick, timeBasis, itemLabel }: MonthCardProps) => (
...
export const YearCalendar = memo(
  ({ selectedYear, data, onYearChange, onDateClick, className, timeBasis, itemLabel }: YearCalendarProps) => {
