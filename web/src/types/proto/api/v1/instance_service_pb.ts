...
export type InstanceProfile = Message<"memos.api.v1.InstanceProfile"> & {
   ...
   *
   * @generated from field: bool web_clipper_supported = 10;
   */
   ...
   *
   * @generated from field: int32 memo_content_max_bytes = 11;
   */
  memoContentMaxBytes: number;
};
