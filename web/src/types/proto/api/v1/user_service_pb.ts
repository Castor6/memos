...
export type UserStats = Message<"memos.api.v1.UserStats"> & {
  ...
  /**
   * Total persisted attachment bytes across all personal spaces, including unlinked uploads.
   * Excludes temporary uploads and derived files. Only returned for the current user.
   *
...
export type UserSetting_GeneralSetting = Message<"memos.api.v1.UserSetting.GeneralSetting"> & {
  ...
  /**
   * User-created personal spaces, keyed by immutable IDs.
   *
   * @generated from field: map<string, string> spaces = 5;
   */
  spaces: { [key: string]: string };

  /**
   * Desktop Enter saves when enabled; mobile Enter always inserts a line.
   *
   * @generated from field: bool enter_to_save = 6;
   */
  enterToSave: boolean;

  /**
   * User-configured words, inserted only through the toolbar.
   *
   * @generated from field: repeated string common_words = 7;
   */
  commonWords: string[];

  /**
   * Visible character limit in feed cards; zero disables text folding.
   *
   * @generated from field: int32 preview_characters = 8;
   */
