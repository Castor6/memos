...
export type Memo = Message<"memos.api.v1.Memo"> & {
   ...
   *
   * @generated from field: string space = 19;
   */
  space: string;
   ...
   *
   * @generated from field: bool is_todo = 20;
   */
  isTodo: boolean;
   ...
   *
   * @generated from field: bool explicit_tags = 21;
   */
   ...
   *
   * @generated from field: repeated memos.api.v1.LinkMetadata link_metadata = 22;
   */
   ...
   *
   * @generated from field: memos.api.v1.MemoCapture capture = 23;
   */
  capture?: MemoCapture | undefined;
};
...
export type ListMemosRequest = Message<"memos.api.v1.ListMemosRequest"> & {
   ...
   *
   * @generated from field: bool is_todo = 7;
   */
  isTodo: boolean;
...
/**
 * @generated from message memos.api.v1.ExportMemoPdfRequest
 */
export type ExportMemoPdfRequest = Message<"memos.api.v1.ExportMemoPdfRequest"> & {
  /**
   * @generated from field: string name = 1;
   */
  name: string;
...
/**
 * Describes the message memos.api.v1.ExportMemoPdfRequest.
 * Use `create(ExportMemoPdfRequestSchema)` to create a new message.
 */
export const ExportMemoPdfRequestSchema: GenMessage<ExportMemoPdfRequest> = /*@__PURE__*/
  messageDesc(file_api_v1_memo_service, 33);

/**
 * @generated from message memos.api.v1.ExportSharedMemoPdfRequest
 */
export type ExportSharedMemoPdfRequest = Message<"memos.api.v1.ExportSharedMemoPdfRequest"> & {
  /**
   * @generated from field: string share_token = 1;
   */
  shareToken: string;
...
/**
 * Describes the message memos.api.v1.ExportSharedMemoPdfRequest.
 * Use `create(ExportSharedMemoPdfRequestSchema)` to create a new message.
 */
export const ExportSharedMemoPdfRequestSchema: GenMessage<ExportSharedMemoPdfRequest> = /*@__PURE__*/
  messageDesc(file_api_v1_memo_service, 34);

/**
 * @generated from message memos.api.v1.ExportMemoPdfResponse
 */
export type ExportMemoPdfResponse = Message<"memos.api.v1.ExportMemoPdfResponse"> & {
  /**
...
/**
 * Describes the message memos.api.v1.ExportMemoPdfResponse.
 * Use `create(ExportMemoPdfResponseSchema)` to create a new message.
 */
export const ExportMemoPdfResponseSchema: GenMessage<ExportMemoPdfResponse> = /*@__PURE__*/
  messageDesc(file_api_v1_memo_service, 35);

/**
 * Structured source material and personal observations saved by the web clipper.
 *
 * @generated from message memos.api.v1.MemoCapture
 */
export type MemoCapture = Message<"memos.api.v1.MemoCapture"> & {
  /**
   * STAR or PICK_UP.
   *
   ...
   */
  posts: MemoCapture_Post[];
};

/**
 * Describes the message memos.api.v1.MemoCapture.
 * Use `create(MemoCaptureSchema)` to create a new message.
 */
export const MemoCaptureSchema: GenMessage<MemoCapture> = /*@__PURE__*/
  messageDesc(file_api_v1_memo_service, 36);

/**
 * @generated from message memos.api.v1.MemoCapture.Post
 */
export type MemoCapture_Post = Message<"memos.api.v1.MemoCapture.Post"> & {
  /**
...
/**
 * Describes the message memos.api.v1.MemoCapture.Post.
 * Use `create(MemoCapture_PostSchema)` to create a new message.
 */
export const MemoCapture_PostSchema: GenMessage<MemoCapture_Post> = /*@__PURE__*/
  messageDesc(file_api_v1_memo_service, 36, 0);
...
export const MemoService: GenService<{
   ...
   *
   * @generated from rpc memos.api.v1.MemoService.ExportMemoPdf
   */
  exportMemoPdf: {
    methodKind: "unary";
    input: typeof ExportMemoPdfRequestSchema;
    output: typeof ExportMemoPdfResponseSchema;
  },
  /**
   * ExportSharedMemoPdf exports only the memo authorized by an active share token.
   *
   * @generated from rpc memos.api.v1.MemoService.ExportSharedMemoPdf
   */
  exportSharedMemoPdf: {
    methodKind: "unary";
    input: typeof ExportSharedMemoPdfRequestSchema;
    output: typeof ExportMemoPdfResponseSchema;
  },
  /**
   * GetMemo gets a memo.
