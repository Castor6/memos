...
type Manifest struct {
	...
	Castor        *PersonalSpaces `json:"castor,omitempty"`
}

// PersonalSpaces preserves the fork's account-local spaces without changing the upstream format.
type PersonalSpaces struct {
	Version int               `json:"version"`
	Spaces  map[string]string `json:"spaces,omitempty"`
}

// PersonalMemo preserves fields that upstream Memos does not define.
type PersonalMemo struct {
	Version      int    `json:"version"`
...
type Memo struct {
	...
	Castor      *PersonalMemo `json:"castor,omitempty"`
}
...
type Attachment struct {
	...
	MotionMedia   json.RawMessage `json:"castorMotionMedia,omitempty"`
}
