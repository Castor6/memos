...
type UserSetting_GeneralSetting struct {
	...
	Spaces map[string]string `protobuf:"bytes,5,rep,name=spaces,proto3" json:"spaces,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	// Desktop Enter saves when enabled; mobile Enter always inserts a line.
	EnterToSave bool `protobuf:"varint,6,opt,name=enter_to_save,json=enterToSave,proto3" json:"enter_to_save,omitempty"`
	// User-configured words, inserted only through the toolbar.
	CommonWords []string `protobuf:"bytes,7,rep,name=common_words,json=commonWords,proto3" json:"common_words,omitempty"`
	// Visible character limit in feed cards; zero disables text folding.
	PreviewCharacters int32 `protobuf:"varint,8,opt,name=preview_characters,json=previewCharacters,proto3" json:"preview_characters,omitempty"`
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
func (x *UserSetting_GeneralSetting) GetSpaces() map[string]string {
	if x != nil {
		return x.Spaces
	}
	return nil
...
func (x *UserSetting_GeneralSetting) GetEnterToSave() bool {
	if x != nil {
		return x.EnterToSave
	}
	return false
}

func (x *UserSetting_GeneralSetting) GetCommonWords() []string {
	if x != nil {
		return x.CommonWords
	}
	return nil
}

func (x *UserSetting_GeneralSetting) GetPreviewCharacters() int32 {
	if x != nil {
		return x.PreviewCharacters
	}
	return 0
}
...
func (x *UserSetting_TagMetadata) GetEmoji() string {
	if x != nil {
		return x.Emoji
	}
	return ""
...
const file_api_v1_user_service_proto_rawDesc = "" +
	...
	"\x19_attachment_storage_bytesJ\x04\b\x02\x10\x03R\x17memo_display_timestamps\"D\n" +
	...
	"\x05stats\x18\x01 \x03(\v2\x17.memos.api.v1.UserStatsR\x05stats\"\xe6\t\n" +
	...
	"\ftags_setting\x18\x06 \x01(\v2%.memos.api.v1.UserSetting.TagsSettingH\x00R\vtagsSetting\x1a\x89\x03\n" +
	...
	"\x05theme\x18\x04 \x01(\tB\x03\xe0A\x01R\x05theme\x12Q\n" +
	"\x06spaces\x18\x05 \x03(\v24.memos.api.v1.UserSetting.GeneralSetting.SpacesEntryB\x03\xe0A\x01R\x06spaces\x12'\n" +
	"\renter_to_save\x18\x06 \x01(\bB\x03\xe0A\x01R\venterToSave\x12&\n" +
	"\fcommon_words\x18\a \x03(\tB\x03\xe0A\x01R\vcommonWords\x122\n" +
	"\x12preview_characters\x18\b \x01(\x05B\x03\xe0A\x01R\x11previewCharacters\x1a9\n" +
	...
	"\fblur_content\x18\x02 \x01(\bB\x03\xe0A\x01R\vblurContent\x12\x14\n" +
	"\x05emoji\x18\x03 \x01(\tR\x05emoji\x1a\xb7\x01\n" +
	"\vTagsSetting\x12H\n" +
...
var file_api_v1_user_service_proto_goTypes = []any{
	...
	nil,                                         // 53: memos.api.v1.UserSetting.GeneralSetting.SpacesEntry
...
var file_api_v1_user_service_proto_depIdxs = []int32{
	...
	55, // 38: memos.api.v1.UserNotification.memo_comment:type_name -> memos.api.v1.UserNotification.MemoCommentPayload
	56, // 39: memos.api.v1.UserNotification.memo_mention:type_name -> memos.api.v1.UserNotification.MemoMentionPayload
	...
	59, // 42: memos.api.v1.UpdateUserNotificationRequest.update_mask:type_name -> google.protobuf.FieldMask
	53, // 43: memos.api.v1.UserSetting.GeneralSetting.spaces:type_name -> memos.api.v1.UserSetting.GeneralSetting.SpacesEntry
