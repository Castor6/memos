...
func (x *Shortcut) GetIsTodo() bool {
	if x != nil {
		return x.IsTodo
	}
	return false
...
const file_api_v1_shortcut_service_proto_rawDesc = "" +
	"\n" +
	"\x1dapi/v1/shortcut_service.proto\x12\fmemos.api.v1\x1a\x1cgoogle/api/annotations.proto\x1a\x17google/api/client.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a google/protobuf/field_mask.proto\"\xcd\x01\n" +
	"\bShortcut\x12\x17\n" +
	"\x04name\x18\x01 \x01(\tB\x03\xe0A\bR\x04name\x12\x19\n" +
	"\x05title\x18\x02 \x01(\tB\x03\xe0A\x02R\x05title\x12\x1b\n" +
	"\x06filter\x18\x03 \x01(\tB\x03\xe0A\x01R\x06filter\x12\x1c\n" +
	"\ais_todo\x18\x04 \x01(\bB\x03\xe0A\x01R\x06isTodo:R\xeaAO\n" +
