...
type WechatKfSetting struct {
	state             protoimpl.MessageState `protogen:"open.v1"`
	Enabled           bool                   `protobuf:"varint,1,opt,name=enabled,proto3" json:"enabled,omitempty"`
	Owner             string                 `protobuf:"bytes,2,opt,name=owner,proto3" json:"owner,omitempty"`
	Space             string                 `protobuf:"bytes,3,opt,name=space,proto3" json:"space,omitempty"`
	CorpId            string                 `protobuf:"bytes,4,opt,name=corp_id,json=corpId,proto3" json:"corp_id,omitempty"`
	KfId              string                 `protobuf:"bytes,5,opt,name=kf_id,json=kfId,proto3" json:"kf_id,omitempty"`
	...
	ChatTag           string                 `protobuf:"bytes,8,opt,name=chat_tag,json=chatTag,proto3" json:"chat_tag,omitempty"`
	ReceiptsEnabled   bool                   `protobuf:"varint,9,opt,name=receipts_enabled,json=receiptsEnabled,proto3" json:"receipts_enabled,omitempty"`
	MaxMediaMb        int32                  `protobuf:"varint,10,opt,name=max_media_mb,json=maxMediaMb,proto3" json:"max_media_mb,omitempty"`
	Secret            string                 `protobuf:"bytes,11,opt,name=secret,proto3" json:"secret,omitempty"`
	CallbackToken     string                 `protobuf:"bytes,12,opt,name=callback_token,json=callbackToken,proto3" json:"callback_token,omitempty"`
	...
	SecretSet         bool                   `protobuf:"varint,14,opt,name=secret_set,json=secretSet,proto3" json:"secret_set,omitempty"`
	CallbackTokenSet  bool                   `protobuf:"varint,15,opt,name=callback_token_set,json=callbackTokenSet,proto3" json:"callback_token_set,omitempty"`
	EncodingAesKeySet bool                   `protobuf:"varint,16,opt,name=encoding_aes_key_set,json=encodingAesKeySet,proto3" json:"encoding_aes_key_set,omitempty"`
	Revision          int64                  `protobuf:"varint,17,opt,name=revision,proto3" json:"revision,omitempty"`
	CallbackPath      string                 `protobuf:"bytes,18,opt,name=callback_path,json=callbackPath,proto3" json:"callback_path,omitempty"`
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}

func (x *WechatKfSetting) Reset() {
	*x = WechatKfSetting{}
...
func (x *WechatKfSetting) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*WechatKfSetting) ProtoMessage() {}

func (x *WechatKfSetting) ProtoReflect() protoreflect.Message {
	mi := &file_api_v1_instance_service_proto_msgTypes[10]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use WechatKfSetting.ProtoReflect.Descriptor instead.
func (*WechatKfSetting) Descriptor() ([]byte, []int) {
	return file_api_v1_instance_service_proto_rawDescGZIP(), []int{10}
}

func (x *WechatKfSetting) GetEnabled() bool {
	if x != nil {
		return x.Enabled
	}
	return false
...
func (x *WechatKfSetting) GetOwner() string {
	if x != nil {
		return x.Owner
	}
	return ""
...
func (x *WechatKfSetting) GetSpace() string {
	if x != nil {
		return x.Space
	}
	return ""
...
func (x *WechatKfSetting) GetCorpId() string {
	if x != nil {
		return x.CorpId
	}
	return ""
...
func (x *WechatKfSetting) GetKfId() string {
	if x != nil {
		return x.KfId
	}
	return ""
...
func (x *WechatKfSetting) GetAllowedUsers() []string {
	if x != nil {
...
func (x *WechatKfSetting) GetDefaultTags() []string {
	if x != nil {
...
func (x *WechatKfSetting) GetChatTag() string {
	if x != nil {
		return x.ChatTag
	}
	return ""
...
func (x *WechatKfSetting) GetReceiptsEnabled() bool {
	if x != nil {
		return x.ReceiptsEnabled
	}
	return false
}

func (x *WechatKfSetting) GetMaxMediaMb() int32 {
	if x != nil {
		return x.MaxMediaMb
	}
	return 0
...
func (x *WechatKfSetting) GetSecret() string {
	if x != nil {
		return x.Secret
	}
	return ""
...
func (x *WechatKfSetting) GetCallbackToken() string {
	if x != nil {
...
func (x *WechatKfSetting) GetEncodingAesKey() string {
	if x != nil {
...
func (x *WechatKfSetting) GetSecretSet() bool {
	if x != nil {
		return x.SecretSet
	}
	return false
...
func (x *WechatKfSetting) GetCallbackTokenSet() bool {
	if x != nil {
		return x.CallbackTokenSet
	}
	return false
}

func (x *WechatKfSetting) GetEncodingAesKeySet() bool {
	if x != nil {
		return x.EncodingAesKeySet
	}
	return false
}

func (x *WechatKfSetting) GetRevision() int64 {
	if x != nil {
		return x.Revision
	}
	return 0
...
func (x *WechatKfSetting) GetCallbackPath() string {
	if x != nil {
...
type GetWechatKfSettingRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *GetWechatKfSettingRequest) Reset() {
	*x = GetWechatKfSettingRequest{}
	mi := &file_api_v1_instance_service_proto_msgTypes[11]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetWechatKfSettingRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetWechatKfSettingRequest) ProtoMessage() {}

func (x *GetWechatKfSettingRequest) ProtoReflect() protoreflect.Message {
	mi := &file_api_v1_instance_service_proto_msgTypes[11]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetWechatKfSettingRequest.ProtoReflect.Descriptor instead.
func (*GetWechatKfSettingRequest) Descriptor() ([]byte, []int) {
	return file_api_v1_instance_service_proto_rawDescGZIP(), []int{11}
}

// Request to replace a configuration at a known revision.
type UpdateWechatKfSettingRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Setting       *WechatKfSetting       `protobuf:"bytes,1,opt,name=setting,proto3" json:"setting,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *UpdateWechatKfSettingRequest) Reset() {
	*x = UpdateWechatKfSettingRequest{}
	mi := &file_api_v1_instance_service_proto_msgTypes[12]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *UpdateWechatKfSettingRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UpdateWechatKfSettingRequest) ProtoMessage() {}

func (x *UpdateWechatKfSettingRequest) ProtoReflect() protoreflect.Message {
	mi := &file_api_v1_instance_service_proto_msgTypes[12]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UpdateWechatKfSettingRequest.ProtoReflect.Descriptor instead.
func (*UpdateWechatKfSettingRequest) Descriptor() ([]byte, []int) {
	return file_api_v1_instance_service_proto_rawDescGZIP(), []int{12}
}

func (x *UpdateWechatKfSettingRequest) GetSetting() *WechatKfSetting {
	if x != nil {
		return x.Setting
	}
	return nil
...
type GetWechatKfStatusRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *GetWechatKfStatusRequest) Reset() {
	*x = GetWechatKfStatusRequest{}
	mi := &file_api_v1_instance_service_proto_msgTypes[13]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetWechatKfStatusRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetWechatKfStatusRequest) ProtoMessage() {}

func (x *GetWechatKfStatusRequest) ProtoReflect() protoreflect.Message {
	mi := &file_api_v1_instance_service_proto_msgTypes[13]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetWechatKfStatusRequest.ProtoReflect.Descriptor instead.
func (*GetWechatKfStatusRequest) Descriptor() ([]byte, []int) {
...
type TestWechatKfSettingRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *TestWechatKfSettingRequest) Reset() {
	*x = TestWechatKfSettingRequest{}
	mi := &file_api_v1_instance_service_proto_msgTypes[14]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *TestWechatKfSettingRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TestWechatKfSettingRequest) ProtoMessage() {}

func (x *TestWechatKfSettingRequest) ProtoReflect() protoreflect.Message {
	mi := &file_api_v1_instance_service_proto_msgTypes[14]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TestWechatKfSettingRequest.ProtoReflect.Descriptor instead.
func (*TestWechatKfSettingRequest) Descriptor() ([]byte, []int) {
...
type WechatKfStatus struct {
	state          protoimpl.MessageState `protogen:"open.v1"`
	Enabled        bool                   `protobuf:"varint,1,opt,name=enabled,proto3" json:"enabled,omitempty"`
	ConsumerActive bool                   `protobuf:"varint,2,opt,name=consumer_active,json=consumerActive,proto3" json:"consumer_active,omitempty"`
	Jobs           map[string]int64       `protobuf:"bytes,3,rep,name=jobs,proto3" json:"jobs,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"varint,2,opt,name=value"`
	Replies        map[string]int64       `protobuf:"bytes,4,rep,name=replies,proto3" json:"replies,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"varint,2,opt,name=value"`
	RecentResults  []*WechatKfResult      `protobuf:"bytes,5,rep,name=recent_results,json=recentResults,proto3" json:"recent_results,omitempty"`
	SyncError      string                 `protobuf:"bytes,6,opt,name=sync_error,json=syncError,proto3" json:"sync_error,omitempty"`
	NextSyncTime   int64                  `protobuf:"varint,7,opt,name=next_sync_time,json=nextSyncTime,proto3" json:"next_sync_time,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}

func (x *WechatKfStatus) Reset() {
	*x = WechatKfStatus{}
...
func (x *WechatKfStatus) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*WechatKfStatus) ProtoMessage() {}

func (x *WechatKfStatus) ProtoReflect() protoreflect.Message {
	mi := &file_api_v1_instance_service_proto_msgTypes[15]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use WechatKfStatus.ProtoReflect.Descriptor instead.
func (*WechatKfStatus) Descriptor() ([]byte, []int) {
	return file_api_v1_instance_service_proto_rawDescGZIP(), []int{15}
}

func (x *WechatKfStatus) GetEnabled() bool {
	if x != nil {
		return x.Enabled
	}
	return false
...
func (x *WechatKfStatus) GetConsumerActive() bool {
	if x != nil {
		return x.ConsumerActive
	}
	return false
}

func (x *WechatKfStatus) GetJobs() map[string]int64 {
	if x != nil {
		return x.Jobs
	}
	return nil
...
func (x *WechatKfStatus) GetReplies() map[string]int64 {
	if x != nil {
		return x.Replies
	}
	return nil
...
func (x *WechatKfStatus) GetRecentResults() []*WechatKfResult {
	if x != nil {
...
func (x *WechatKfStatus) GetSyncError() string {
	if x != nil {
		return x.SyncError
	}
	return ""
...
func (x *WechatKfStatus) GetNextSyncTime() int64 {
	if x != nil {
...
func (x *WechatKfResult) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*WechatKfResult) ProtoMessage() {}

func (x *WechatKfResult) ProtoReflect() protoreflect.Message {
	mi := &file_api_v1_instance_service_proto_msgTypes[16]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use WechatKfResult.ProtoReflect.Descriptor instead.
func (*WechatKfResult) Descriptor() ([]byte, []int) {
	return file_api_v1_instance_service_proto_rawDescGZIP(), []int{16}
}

func (x *WechatKfResult) GetType() string {
	if x != nil {
		return x.Type
	}
	return ""
...
func (x *WechatKfResult) GetState() string {
	if x != nil {
		return x.State
	}
	return ""
...
func (x *WechatKfResult) GetAttempts() int32 {
	if x != nil {
		return x.Attempts
	}
	return 0
...
func (x *WechatKfResult) GetError() string {
	if x != nil {
		return x.Error
	}
	return ""
...
func (x *WechatKfResult) GetCreatedTime() int64 {
	if x != nil {
...
const file_api_v1_instance_service_proto_rawDesc = "" +
	...
	"\n" +
	"size_bytes\x18\x02 \x01(\x03R\tsizeBytes\"\x80\x05\n" +
	"\x0fWechatKfSetting\x12\x18\n" +
	"\aenabled\x18\x01 \x01(\bR\aenabled\x12\x14\n" +
	"\x05owner\x18\x02 \x01(\tR\x05owner\x12\x14\n" +
	"\x05space\x18\x03 \x01(\tR\x05space\x12\x17\n" +
	"\acorp_id\x18\x04 \x01(\tR\x06corpId\x12\x13\n" +
	"\x05kf_id\x18\x05 \x01(\tR\x04kfId\x12#\n" +
	"\rallowed_users\x18\x06 \x03(\tR\fallowedUsers\x12!\n" +
	"\fdefault_tags\x18\a \x03(\tR\vdefaultTags\x12\x19\n" +
	"\bchat_tag\x18\b \x01(\tR\achatTag\x12)\n" +
	"\x10receipts_enabled\x18\t \x01(\bR\x0freceiptsEnabled\x12 \n" +
	"\fmax_media_mb\x18\n" +
	" \x01(\x05R\n" +
	"maxMediaMb\x12\x1b\n" +
	"\x06secret\x18\v \x01(\tB\x03\xe0A\x04R\x06secret\x12*\n" +
	"\x0ecallback_token\x18\f \x01(\tB\x03\xe0A\x04R\rcallbackToken\x12-\n" +
	"\x10encoding_aes_key\x18\r \x01(\tB\x03\xe0A\x04R\x0eencodingAesKey\x12\"\n" +
	"\n" +
	"secret_set\x18\x0e \x01(\bB\x03\xe0A\x03R\tsecretSet\x121\n" +
	"\x12callback_token_set\x18\x0f \x01(\bB\x03\xe0A\x03R\x10callbackTokenSet\x124\n" +
	"\x14encoding_aes_key_set\x18\x10 \x01(\bB\x03\xe0A\x03R\x11encodingAesKeySet\x12\x1a\n" +
	"\brevision\x18\x11 \x01(\x03R\brevision\x12(\n" +
	"\rcallback_path\x18\x12 \x01(\tB\x03\xe0A\x03R\fcallbackPath\"\x1b\n" +
	"\x19GetWechatKfSettingRequest\"\\\n" +
	"\x1cUpdateWechatKfSettingRequest\x12<\n" +
	"\asetting\x18\x01 \x01(\v2\x1d.memos.api.v1.WechatKfSettingB\x03\xe0A\x02R\asetting\"\x1a\n" +
	"\x18GetWechatKfStatusRequest\"\x1c\n" +
	"\x1aTestWechatKfSettingRequest\"\xd3\x03\n" +
	"\x0eWechatKfStatus\x12\x18\n" +
	"\aenabled\x18\x01 \x01(\bR\aenabled\x12'\n" +
	"\x0fconsumer_active\x18\x02 \x01(\bR\x0econsumerActive\x12:\n" +
	"\x04jobs\x18\x03 \x03(\v2&.memos.api.v1.WechatKfStatus.JobsEntryR\x04jobs\x12C\n" +
	"\areplies\x18\x04 \x03(\v2).memos.api.v1.WechatKfStatus.RepliesEntryR\areplies\x12C\n" +
	"\x0erecent_results\x18\x05 \x03(\v2\x1c.memos.api.v1.WechatKfResultR\rrecentResults\x12\x1d\n" +
	"\n" +
	"sync_error\x18\x06 \x01(\tR\tsyncError\x12$\n" +
	"\x0enext_sync_time\x18\a \x01(\x03R\fnextSyncTime\x1a7\n" +
	"\tJobsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\x03R\x05value:\x028\x01\x1a:\n" +
	"\fRepliesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\x03R\x05value:\x028\x01\"\x8f\x01\n" +
	"\x0eWechatKfResult\x12\x12\n" +
	"\x04type\x18\x01 \x01(\tR\x04type\x12\x14\n" +
	"\x05state\x18\x02 \x01(\tR\x05state\x12\x1a\n" +
	"\battempts\x18\x03 \x01(\x05R\battempts\x12\x14\n" +
	"\x05error\x18\x04 \x01(\tR\x05error\x12!\n" +
	"\fcreated_time\x18\x05 \x01(\x03R\vcreatedTime2\xbb\v\n" +
	"\x0fInstanceService\x12\x80\x01\n" +
	"\x12GetWechatKfSetting\x12'.memos.api.v1.GetWechatKfSettingRequest\x1a\x1d.memos.api.v1.WechatKfSetting\"\"\x82\xd3\xe4\x93\x02\x1c\x12\x1a/api/v1/instance/wechat-kf\x12\x89\x01\n" +
	"\x15UpdateWechatKfSetting\x12*.memos.api.v1.UpdateWechatKfSettingRequest\x1a\x1d.memos.api.v1.WechatKfSetting\"%\x82\xd3\xe4\x93\x02\x1f:\x01*2\x1a/api/v1/instance/wechat-kf\x12\x84\x01\n" +
	"\x11GetWechatKfStatus\x12&.memos.api.v1.GetWechatKfStatusRequest\x1a\x1c.memos.api.v1.WechatKfStatus\")\x82\xd3\xe4\x93\x02#\x12!/api/v1/instance/wechat-kf/status\x12\x83\x01\n" +
	"\x13TestWechatKfSetting\x12(.memos.api.v1.TestWechatKfSettingRequest\x1a\x16.google.protobuf.Empty\"*\x82\xd3\xe4\x93\x02$:\x01*\"\x1f/api/v1/instance/wechat-kf:test\x12~\n" +
...
var file_api_v1_instance_service_proto_msgTypes = make([]protoimpl.MessageInfo, 33)
var file_api_v1_instance_service_proto_goTypes = []any{
	...
	(*WechatKfSetting)(nil),                              // 13: memos.api.v1.WechatKfSetting
	(*GetWechatKfSettingRequest)(nil),                    // 14: memos.api.v1.GetWechatKfSettingRequest
	(*UpdateWechatKfSettingRequest)(nil),                 // 15: memos.api.v1.UpdateWechatKfSettingRequest
	(*GetWechatKfStatusRequest)(nil),                     // 16: memos.api.v1.GetWechatKfStatusRequest
	(*TestWechatKfSettingRequest)(nil),                   // 17: memos.api.v1.TestWechatKfSettingRequest
	(*WechatKfStatus)(nil),                               // 18: memos.api.v1.WechatKfStatus
	(*WechatKfResult)(nil),                               // 19: memos.api.v1.WechatKfResult
	(*InstanceSetting_GeneralSetting)(nil),               // 20: memos.api.v1.InstanceSetting.GeneralSetting
	(*InstanceSetting_StorageSetting)(nil),               // 21: memos.api.v1.InstanceSetting.StorageSetting
	(*InstanceSetting_MemoRelatedSetting)(nil),           // 22: memos.api.v1.InstanceSetting.MemoRelatedSetting
	(*InstanceSetting_TagMetadata)(nil),                  // 23: memos.api.v1.InstanceSetting.TagMetadata
	(*InstanceSetting_TagsSetting)(nil),                  // 24: memos.api.v1.InstanceSetting.TagsSetting
	(*InstanceSetting_NotificationSetting)(nil),          // 25: memos.api.v1.InstanceSetting.NotificationSetting
	(*InstanceSetting_AISetting)(nil),                    // 26: memos.api.v1.InstanceSetting.AISetting
	(*InstanceSetting_AIProviderConfig)(nil),             // 27: memos.api.v1.InstanceSetting.AIProviderConfig
	(*InstanceSetting_TranscriptionConfig)(nil),          // 28: memos.api.v1.InstanceSetting.TranscriptionConfig
	...
	nil,                                                      // 34: memos.api.v1.WechatKfStatus.JobsEntry
	nil,                                                      // 35: memos.api.v1.WechatKfStatus.RepliesEntry
...
var file_api_v1_instance_service_proto_depIdxs = []int32{
	...
	20, // 1: memos.api.v1.InstanceSetting.general_setting:type_name -> memos.api.v1.InstanceSetting.GeneralSetting
	21, // 2: memos.api.v1.InstanceSetting.storage_setting:type_name -> memos.api.v1.InstanceSetting.StorageSetting
	22, // 3: memos.api.v1.InstanceSetting.memo_related_setting:type_name -> memos.api.v1.InstanceSetting.MemoRelatedSetting
	24, // 4: memos.api.v1.InstanceSetting.tags_setting:type_name -> memos.api.v1.InstanceSetting.TagsSetting
	25, // 5: memos.api.v1.InstanceSetting.notification_setting:type_name -> memos.api.v1.InstanceSetting.NotificationSetting
	26, // 6: memos.api.v1.InstanceSetting.ai_setting:type_name -> memos.api.v1.InstanceSetting.AISetting
	...
	37, // 9: memos.api.v1.UpdateInstanceSettingRequest.update_mask:type_name -> google.protobuf.FieldMask
	...
	33, // 11: memos.api.v1.InstanceStats.database:type_name -> memos.api.v1.InstanceStats.DatabaseStats
	38, // 12: memos.api.v1.InstanceStats.generated_time:type_name -> google.protobuf.Timestamp
	13, // 13: memos.api.v1.UpdateWechatKfSettingRequest.setting:type_name -> memos.api.v1.WechatKfSetting
	34, // 14: memos.api.v1.WechatKfStatus.jobs:type_name -> memos.api.v1.WechatKfStatus.JobsEntry
	35, // 15: memos.api.v1.WechatKfStatus.replies:type_name -> memos.api.v1.WechatKfStatus.RepliesEntry
	19, // 16: memos.api.v1.WechatKfStatus.recent_results:type_name -> memos.api.v1.WechatKfResult
	...
	30, // 19: memos.api.v1.InstanceSetting.StorageSetting.s3_config:type_name -> memos.api.v1.InstanceSetting.StorageSetting.S3Config
	39, // 20: memos.api.v1.InstanceSetting.TagMetadata.background_color:type_name -> google.type.Color
	31, // 21: memos.api.v1.InstanceSetting.TagsSetting.tags:type_name -> memos.api.v1.InstanceSetting.TagsSetting.TagsEntry
	32, // 22: memos.api.v1.InstanceSetting.NotificationSetting.email:type_name -> memos.api.v1.InstanceSetting.NotificationSetting.EmailSetting
	27, // 23: memos.api.v1.InstanceSetting.AISetting.providers:type_name -> memos.api.v1.InstanceSetting.AIProviderConfig
	28, // 24: memos.api.v1.InstanceSetting.AISetting.transcription:type_name -> memos.api.v1.InstanceSetting.TranscriptionConfig
	1,  // 25: memos.api.v1.InstanceSetting.AIProviderConfig.type:type_name -> memos.api.v1.InstanceSetting.AIProviderType
	23, // 26: memos.api.v1.InstanceSetting.TagsSetting.TagsEntry.value:type_name -> memos.api.v1.InstanceSetting.TagMetadata
	14, // 27: memos.api.v1.InstanceService.GetWechatKfSetting:input_type -> memos.api.v1.GetWechatKfSettingRequest
	15, // 28: memos.api.v1.InstanceService.UpdateWechatKfSetting:input_type -> memos.api.v1.UpdateWechatKfSettingRequest
	16, // 29: memos.api.v1.InstanceService.GetWechatKfStatus:input_type -> memos.api.v1.GetWechatKfStatusRequest
	17, // 30: memos.api.v1.InstanceService.TestWechatKfSetting:input_type -> memos.api.v1.TestWechatKfSettingRequest
	4,  // 31: memos.api.v1.InstanceService.GetInstanceProfile:input_type -> memos.api.v1.GetInstanceProfileRequest
	6,  // 32: memos.api.v1.InstanceService.GetInstanceSetting:input_type -> memos.api.v1.GetInstanceSettingRequest
	7,  // 33: memos.api.v1.InstanceService.BatchGetInstanceSettings:input_type -> memos.api.v1.BatchGetInstanceSettingsRequest
	9,  // 34: memos.api.v1.InstanceService.UpdateInstanceSetting:input_type -> memos.api.v1.UpdateInstanceSettingRequest
	10, // 35: memos.api.v1.InstanceService.TestInstanceEmailSetting:input_type -> memos.api.v1.TestInstanceEmailSettingRequest
	11, // 36: memos.api.v1.InstanceService.GetInstanceStats:input_type -> memos.api.v1.GetInstanceStatsRequest
	13, // 37: memos.api.v1.InstanceService.GetWechatKfSetting:output_type -> memos.api.v1.WechatKfSetting
	13, // 38: memos.api.v1.InstanceService.UpdateWechatKfSetting:output_type -> memos.api.v1.WechatKfSetting
	18, // 39: memos.api.v1.InstanceService.GetWechatKfStatus:output_type -> memos.api.v1.WechatKfStatus
	40, // 40: memos.api.v1.InstanceService.TestWechatKfSetting:output_type -> google.protobuf.Empty
	3,  // 41: memos.api.v1.InstanceService.GetInstanceProfile:output_type -> memos.api.v1.InstanceProfile
	5,  // 42: memos.api.v1.InstanceService.GetInstanceSetting:output_type -> memos.api.v1.InstanceSetting
	8,  // 43: memos.api.v1.InstanceService.BatchGetInstanceSettings:output_type -> memos.api.v1.BatchGetInstanceSettingsResponse
	5,  // 44: memos.api.v1.InstanceService.UpdateInstanceSetting:output_type -> memos.api.v1.InstanceSetting
	40, // 45: memos.api.v1.InstanceService.TestInstanceEmailSetting:output_type -> google.protobuf.Empty
	12, // 46: memos.api.v1.InstanceService.GetInstanceStats:output_type -> memos.api.v1.InstanceStats
