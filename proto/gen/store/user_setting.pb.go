...
type GeneralUserSetting struct {
	...
	Spaces map[string]string `protobuf:"bytes,4,rep,name=spaces,proto3" json:"spaces,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	// Desktop Enter saves when enabled; mobile Enter always inserts a line.
	EnterToSave bool `protobuf:"varint,5,opt,name=enter_to_save,json=enterToSave,proto3" json:"enter_to_save,omitempty"`
	// User-configured words, inserted only through the toolbar.
	CommonWords []string `protobuf:"bytes,6,rep,name=common_words,json=commonWords,proto3" json:"common_words,omitempty"`
	// Visible character limit in feed cards; zero disables text folding.
	PreviewCharacters int32 `protobuf:"varint,7,opt,name=preview_characters,json=previewCharacters,proto3" json:"preview_characters,omitempty"`
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
func (x *GeneralUserSetting) GetSpaces() map[string]string {
	if x != nil {
		return x.Spaces
	}
	return nil
...
func (x *GeneralUserSetting) GetEnterToSave() bool {
	if x != nil {
...
func (x *GeneralUserSetting) GetCommonWords() []string {
	if x != nil {
...
func (x *GeneralUserSetting) GetPreviewCharacters() int32 {
	if x != nil {
...
func (x *UserTagMetadata) GetEmoji() string {
	if x != nil {
		return x.Emoji
	}
	return ""
...
const file_store_user_setting_proto_rawDesc = "" +
	...
	"\x06spaces\x18\x04 \x03(\v2+.memos.store.GeneralUserSetting.SpacesEntryR\x06spaces\x12\"\n" +
	"\renter_to_save\x18\x05 \x01(\bR\venterToSave\x12!\n" +
	"\fcommon_words\x18\x06 \x03(\tR\vcommonWords\x12-\n" +
	"\x12preview_characters\x18\a \x01(\x05R\x11previewCharacters\x1a9\n" +
	...
	"\x05emoji\x18\x03 \x01(\tR\x05emoji\"\xa4\x01\n" +
...
var file_store_user_setting_proto_goTypes = []any{
	...
	nil,                                     // 9: memos.store.GeneralUserSetting.SpacesEntry
...
var file_store_user_setting_proto_depIdxs = []int32{
	...
	9,  // 7: memos.store.GeneralUserSetting.spaces:type_name -> memos.store.GeneralUserSetting.SpacesEntry
